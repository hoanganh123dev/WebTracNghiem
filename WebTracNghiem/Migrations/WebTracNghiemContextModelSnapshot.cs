...
{
    [DbContext(typeof(WebTracNghiemContext))]
    partial class WebTracNghiemContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebTracNghiem.Models.Bai", b =>
                {
            ...
            modelBuilder.Entity("WebTracNghiem.Models.BaiLam", b =>
                {
            ...
            modelBuilder.Entity("WebTracNghiem.Models.CauHoi", b =>
                {
            ...
            modelBuilder.Entity("WebTracNghiem.Models.CauHoi_BaiLam", b =>
                {
            ...
            modelBuilder.Entity("WebTracNghiem.Models.CauHoi_De", b =>
                {
                    b.Property<int>("CauHoi_DeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebTracNghiem.Models.Chuong", b =>
                {
                    b.Property<int>("ChuongId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebTracNghiem.Models.DanhSachThi", b =>
                {
            ...
            modelBuilder.Entity("WebTracNghiem.Models.De", b =>
                {
                    b.Property<int>("DeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebTracNghiem.Models.GiaoVien", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebTracNghiem.Models.KyKiemTra", b =>
                {
                    b.Property<int>("KyKiemTraId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebTracNghiem.Models.MonHoc", b =>
                {
                    b.Property<int>("MonHocId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebTracNghiem.Models.Muc", b =>
                {
            ...
            modelBuilder.Entity("WebTracNghiem.Models.TaiKhoan", b =>
                {
                    b.Property<int>("TaiKhoanId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebTracNghiem.Models.Bai", b =>
                {
                    b.HasOne("WebTracNghiem.Models.Chuong", "Chuong")
                        .WithMany("Bais")
            ...
            modelBuilder.Entity("WebTracNghiem.Models.CauHoi_BaiLam", b =>
                {
                    b.HasOne("WebTracNghiem.Models.BaiLam", "BaiLam")
                        .WithMany("CauHoi_BaiLam")
                        .HasForeignKey("BaiLamId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebTracNghiem.Models.CauHoi_De", "CauHoi_De")
                        .WithMany("CauHoi_BaiLam")
            ...
            modelBuilder.Entity("WebTracNghiem.Models.CauHoi_De", b =>
                {
                    b.HasOne("WebTracNghiem.Models.CauHoi", "CauHoi")
                        .WithMany("CauHoi_De")
                        .HasForeignKey("CauHoiId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebTracNghiem.Models.De", "De")
            ...
            modelBuilder.Entity("WebTracNghiem.Models.Chuong", b =>
                {
                    b.HasOne("WebTracNghiem.Models.MonHoc", "MonHoc")
                        .WithMany("Chuongs")
            ...
            modelBuilder.Entity("WebTracNghiem.Models.DanhSachThi", b =>
                {
                    b.HasOne("WebTracNghiem.Models.KyKiemTra", "KyKiemTra")
                        .WithMany("DanhSachThi")
                        .HasForeignKey("KyKiemTraId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebTracNghiem.Models.TaiKhoan", "TaiKhoan")
                        .WithMany()
            ...
            modelBuilder.Entity("WebTracNghiem.Models.Muc", b =>
                {
                    b.HasOne("WebTracNghiem.Models.Bai", "Bai")
                        .WithMany("Mucs")
                        .HasForeignKey("BaiId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
