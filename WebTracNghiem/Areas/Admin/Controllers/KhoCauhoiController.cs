...
namespace WebTracNghiem.Areas.Admin.Controllers
{
    ...
    public class KhoCauHoiController : Controller
    {
        ...
        public KhoCauHoiController(WebTracNghiemContext context, IConfiguration configuration, INotyfService notyfService)
        {
            _context = context;
        ...
        public IActionResult CreateList(IFormFile formFile)
        {
            try
            {
                ...
                string ConString = _configuration.GetConnectionString("WebTracNghiem");
                ...
                using (ExcelPackage package = new ExcelPackage(fileInfo))
                {
                  ...
                  var  conString = _configuration.GetConnectionString("WebTracNghiem");
                    using (SqlConnection con = new SqlConnection(conString))
                    {
