...
namespace WebTracNghiem.Areas.Admin.Controllers
{
    ...
    public class TaiKhoanController : Controller
    {
        ...
        public TaiKhoanController(WebTracNghiemContext context, INotyfService notyfService, IConfiguration configuration, ILogger<TaiKhoanController> logger)
        {
            _context = context;
